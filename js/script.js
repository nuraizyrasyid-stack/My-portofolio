...
// ==================== MODAL PORTOFOLIO MATAN ====================
const matanModal = document.getElementById('matanModal');
const modalTitle = document.getElementById('modalTitle');
const modalDesc = document.getElementById('modalDesc');
const openDocBtn = document.getElementById('openDocBtn');
let currentLink = '';

// Klik tombol "Lihat Detail" pada card matan
document.querySelectorAll('.matan-card .btn-detail').forEach(btn => {
    btn.addEventListener('click', function () {
        ...
        matanModal.style.display = 'flex';
    });
});

// Tombol "Buka Dokumen Lengkap"
if (openDocBtn) {
...
// Fungsi tutup modal
function closeMatanModal() {
    if (matanModal) matanModal.style.display = 'none';
}

// Klik di luar modal untuk close
if (matanModal) {
    matanModal.addEventListener('click', function (e) {
        if (e.target === matanModal) {
            closeMatanModal();
        }
    });
}

// Tekan tombol ESC untuk close
document.addEventListener('keydown', function (e) {
    if (e.key === "Escape" && matanModal && matanModal.style.display === 'flex') {
        closeMatanModal();
    }
});